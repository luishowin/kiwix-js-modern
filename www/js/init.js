...
document.getElementById('appVersion').textContent = 'KIWIX';
var homeVersionEl = document.getElementById('homeVersion');
if (homeVersionEl) homeVersionEl.textContent = 'Kiwix ' + params.appVersion;
